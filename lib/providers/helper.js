...
exports._clearElements = exports.isLinearElementType = exports._clearAppState = void 0;
...
const _clearAppState = appState => {
  const stateForExport = {};

  for (const key of Object.keys(appState)) {
    const propConfig = APP_STATE_STORAGE_CONF[key];

    if (propConfig !== null && propConfig !== void 0 && propConfig["export"]) {
...
exports._clearAppState = _clearAppState;
...
const _clearElements = elements => {
  return elements.map(element => isLinearElementType(element.type) ? { ...element,
    lastCommittedPoint: null
  } : element);
};

exports._clearElements = _clearElements;